...
{
  type __IsExpected<Specific extends AppPageConfig<"/app/companies">> = Specific
...
// Validate ../../src/app/api/jobs/focus/poll/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/jobs/focus/poll">> = Specific
  const handler = {} as typeof import("../../src/app/api/jobs/focus/poll/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/webhooks/focus/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/webhooks/focus">> = Specific
  const handler = {} as typeof import("../../src/app/api/webhooks/focus/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
